namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalculateAverageTicketPriceProcessMethodsWrapper

	/// <exclude/>
	public class UsrCalculateAverageTicketPriceProcessMethodsWrapper : ProcessModel
	{

		public UsrCalculateAverageTicketPriceProcessMethodsWrapper(Process process)
			: base(process) {
